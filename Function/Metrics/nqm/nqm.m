...
A_1=gthresh(c1,d1,a_1);AI_1=gthresh(ci1,d1,ai_1);
A_2=gthresh(c2,d2,a_2);AI_2=gthresh(ci2,d2,ai_2);
A_3=gthresh(c3,d3,a_3);AI_3=gthresh(ci3,d3,ai_3);
A_4=gthresh(c4,d4,a_4);AI_4=gthresh(ci4,d4,ai_4);
A_5=gthresh(c5,d5,a_5);AI_5=gthresh(ci5,d5,ai_5);
